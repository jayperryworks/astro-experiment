...
import { sentenceCase, camelCase, paramCase } from './stringHelpers.js';
import ApolloClient from 'apollo-client';
import convertColor from 'color-convert';
// import fetch from 'node-fetch';
import fragmentTypes from './prismicFragments.json';
import gql from 'graphql-tag';
import markdown from './renderMarkdown.js';
import prismicHelpers from '@prismicio/helpers';

const accessToken = import.meta.env.PRISMIC_TOKEN;
...
export function getString(field) {
	return prismicHelpers.asText(field);
...
export function renderBlockContent (blocks) {
...
export function convertColorToHSL (hex) {
